    ...
    public class NoExpedienteAttribute : ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext context)
        {
            ...
            if (value.ToString().Contains("-"))
            {
                ...
                {
                    return new ValidationResult("El numero del expediente no contiene la nomenglatura adecuada");
                }
            }
            else
            {
                return new ValidationResult("El numero del expediente no contiene un '-'");
            }
            return ValidationResult.Success;
        }
    }
